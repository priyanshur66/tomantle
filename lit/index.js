...
export const signAndCombineAndSendTx = async () => {
    ...
    try {
        ...
        const ethersWallet = new ethers.Wallet(ETHEREUM_PRIVATE_KEY, new ethers.providers.JsonRpcProvider(chainInfo.rpcUrl));
        ...
        if (capacityTokenId === "" || capacityTokenId === undefined) {
            ...
            capacityTokenId = (await litContracts.mintCapacityCreditsNFT({
